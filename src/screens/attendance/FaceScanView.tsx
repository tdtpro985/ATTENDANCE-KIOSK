    ...
    return (
      <View style={styles.portraitFaceContainer} onLayout={handleOverlayLayout}>
        <View style={getDynamicCameraStyle()}>
          <Camera ref={cameraRef} style={styles.fullScreenCamera} device={device} format={cameraFormat} isActive={true} photo={true} fps={15} pixelFormat="yuv" frameProcessor={frameProcessor} androidPreviewViewType="texture-view" outputOrientation="device" resizeMode="cover" photoQualityBalance="speed" />
        </View>
